...
// (https://godoc.org/github.com/facily-tech/go-agent/v3/integrations) directory --
...
// (https://godoc.org/github.com/facily-tech/go-agent/v3/newrelic#Transaction.AddAttribute)
